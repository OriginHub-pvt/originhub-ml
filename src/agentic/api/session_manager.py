...
class SessionManager:
    ...
    def create_session(self, runner: InteractivePipelineRunner, session_id: Optional[str] = None) -> str:
        """Create a new session.
        
        Parameters
        ----------
        runner : InteractivePipelineRunner
            The pipeline runner instance for this session.
        session_id : Optional[str]
            If provided, use this session_id instead of generating a new one.
            
        Returns
        -------
        str
            The session_id (either provided or newly generated).
        """
